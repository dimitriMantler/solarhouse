...
/**
 * Selfdefined JQuery functions.
 * INDEX:
 *********
 * $.postJSON(url, data, callback, errorCallback);
 * IE.trim()
 * IE.JSON undefiened -> load a javascript file
 * $(type = input).ForceNumericOnly();
 */
 ...
 * of it.
 * 
 * SOURCE: http://benjamin-schweizer.de/jquerypostjson.html
 */
...
/**
 * IE 8 and lower will need to have the json2.js lib included.
 * 
 * SOURCE: http://stackoverflow.com/questions/5339232/json-is-undefined-error-in-javascript-in-internet-explorer
 */
if(typeof JSON == 'undefined'){
	console.log("json2.js included for IE 8 and lower");
	$.getScript("../script/util/jsonForIE.js");
}

/**
 * This function can be called by input fields to add a number checking function. It will only allow
 * number to be written. No floating point numbers!
 * 
